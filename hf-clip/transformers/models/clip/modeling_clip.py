...
class CLIPAttention(nn.Module):
    ...
    def forward(
        ...
        if sinusoidal_pos is not None:
            ...
            query_states, key_states = map(lambda x: x.view(*proj_shape), (query_states, key_states))
...
class CLIPEncoder(nn.Module):
    ...
    def forward(
        ...
        if self.rotary:
            sinusoidal_pos = self.embed_rotary_positions(hidden_states.shape[:-1])[None, None, :, :]
        else:
            sinusoidal_pos = None
